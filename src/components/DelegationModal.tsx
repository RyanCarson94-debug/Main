  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl bg-[#1A1035] border border-amber-500/30 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="overflow-y-auto flex-1 p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-black/30 border border-[#2D1F5E] rounded-xl px-4 py-3 text-white text-sm placeholder-gray-600 focus:outline-none focus:border-amber-500/50 transition-colors"
              />
            </div>
            <div>
              ...
              <input
                ...
                className="w-full bg-black/30 border border-[#2D1F5E] rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-amber-500/50 transition-colors [color-scheme:dark]"
              />
            </div>
          </div>
          ...
          <div>
                ...
                <button
                  ...
                  className={`
                    ...
                    ${isStreaming || !delegatee.trim()
                      ...
                      : 'bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white hover:shadow-lg hover:shadow-purple-500/20'
                    }
                  `}
                >
                  {isStreaming
            ...
            {emailDraft || isStreaming ? (
              ...
              <div className="flex flex-col items-center justify-center h-28 rounded-xl border border-dashed border-[#2D1F5E] text-center text-gray-600">
        ...
        {/* Footer */}
        <div className="flex gap-3 px-6 py-4 border-t border-[#2D1F5E] shrink-0">
          <button
            onClick={onClose}
