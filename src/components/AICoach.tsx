...
export function AICoach({ tasks, okrs, decisions, onClose }: AICoachProps) {
  ...
  return (
    <div className="fixed right-0 top-0 h-[100dvh] w-full md:w-[380px] bg-[#1A1824] border-l border-[#2A2640] flex flex-col z-40 shadow-2xl shadow-black/50 animate-[slideInRight_0.22s_ease-out]">
      {/* Header */}
