...
export function SearchOverlay({ open, onClose, onNavigate, data }: SearchOverlayProps) {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-start justify-center pt-[15vh] px-4" onClick={onClose}>
      ...
      <div className="relative w-full max-w-xl rounded-2xl bg-[#0C0820] border border-purple-500/30 shadow-2xl shadow-purple-500/10 overflow-hidden" onClick={e => e.stopPropagation()}>
        {/* Input */}
        ...
        {results.length > 0 && (
          <div className="px-4 py-2 border-t border-[#2D1F5E] text-[11px] text-gray-700">
