...
function DecisionFormModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={onClose}>
      <div className="w-full max-w-lg rounded-2xl bg-[#0C0820] border border-[#2D1F5E] shadow-2xl overflow-hidden max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#2D1F5E] shrink-0">
        ...
        <div className="flex gap-2 px-6 py-4 border-t border-[#2D1F5E] shrink-0">
...
function DecisionCard({
  ...
  return (
    <>
      <div className="rounded-xl bg-[#16103A] border border-[#2D1F5E] overflow-hidden">
        ...
        {expanded && (
          <div className="px-4 pb-4 space-y-3 border-t border-[#2D1F5E] pt-3">
        ...
        {(['decisions', 'commitments'] as Tab[]).map(t => (
          <button
            ...
            className={`px-4 py-2 rounded-xl text-sm font-bold transition-all capitalize ${
              tab === t ? 'bg-purple-600/20 text-white border border-purple-500/30' : 'text-gray-500 hover:text-gray-300 hover:bg-white/5'
            }`}
          >
            {t}
...
function CommitmentRow({
  ...
  return (
    <div className={`flex items-center gap-3 px-3 py-2.5 rounded-xl border group ${overdue ? 'bg-red-500/5 border-red-500/15' : 'bg-[#16103A] border-[#2D1F5E]'}`}>
